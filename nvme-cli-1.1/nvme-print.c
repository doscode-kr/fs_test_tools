/*=============================================================================
 * SKHMS NVME Express Utility Tool for SSD VU command 
 *-----------------------------------------------------------------------------
 * This is based on nvme-cli-1.1 release
 *
 * This file is fiexd a little for VU command of SK hyinx SSD
 *
 * Author : Hyunyoung Lee < hyunyoung.lee@skhms.com > 
 *
 *============================================================================*/
...
// For VU command of SK hynix SSD
// big endian ? little endian??
static long double int128_to_double2(__u8 *data)
{
        int i;
        long double result = 0;
...
void show_get_wai_information(__u32 *result, unsigned int nsid, const char *devname)
{
	printf("WAI information NVME device:%s namespace-id:%x\n", devname, nsid);
  	printf("dataUnitsWrite.dw[0] : %u, 0x%x, end_of_dataUnitsWrite.dw[0]\n", result[0], result[0]);
	printf("dataUnitsWrite.dw[1] : %u, 0x%x, end_of_dataUnitsWrite.dw[1]\n", result[1], result[1]);
	printf("dataUnitsWrite.dw[2] : %u, 0x%x, end_of_dataUnitsWrite.dw[2]\n", result[2], result[2]);
	printf("dataUnitsWrite.dw[3] : %u, 0x%x, end_of_dataUnitsWrite.dw[3]\n", result[3], result[3]);
	printf("controllerDataUnitsWritten.dw[0] : %u, 0x%x, end_of_controllerDataUnitsWritten.dw[0]\n", result[4], result[4]);
	printf("controllerDataUnitsWritten.dw[1] : %u, 0x%x, end_of_controllerDataUnitsWritten.dw[1]\n", result[5], result[5]);
 	printf("controllerDataUnitsWritten.dw[2] : %u, 0x%x, end_of_controllerDataUnitsWritten.dw[2]\n", result[6], result[6]);
	printf("controllerDataUnitsWritten.dw[3] : %u, 0x%x, end_of_controllerDataUnitsWritten.dw[3]\n", result[7], result[7]);

	printf("dataUnitsWrite.dw : %'.0Lf / controllerDataUnitWritten.dw : %'.0Lf\n", int128_to_double2((__u8 *)result), int128_to_double2((__u8 *)(result+4)));
	printf("%'.0Lf / %'.0Lf\n", int128_to_double2((__u8 *)result), int128_to_double2((__u8 *)(result+4)));

...
COMMAND_LIST(
	...
	ENTRY("get-wai", "get WAI information from NVMe subsystem for WAF",get_wai_information)
//	ENTRY("clear-wai", "Clear WAI information form NVMe subsystem for WAF", clear_wai_information)
);

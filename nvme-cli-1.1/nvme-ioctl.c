...
int skhynix_send_descriptor(int fd, __u32 nsid, __u32 cdw10, __u32 data_len, void *data)
{
  struct nvme_admin_cmd cmd = {
	 
	 /* Fused Operation (FUSE) : CDW0[9:8]
 	  * 	
 	  ...
 	  * 0x3 : Reserved
 	  */
	.opcode		= 0xE3,//nvme_admin_send_descriptor;
	.flags		= 0,
	.nsid		= nsid, // default 1
	.cdw10		= cdw10, 
	.cdw11		= seq_id++,
	...
	//cdw14		= 0 // not used
	//cdw15		= 0 // not used
	//timeout_ms 	= 0 // 0 : ADMIN_TIMEOUT in kernel dreiver shall be used
	.addr		= (__u64)(uintptr_t) data, 
	.data_len	= data_len,
  };
...
int nvme_wai_information(int fd, __u32 nsid, __u32 len, void *data)
{
  return skhynix_send_descriptor(fd, nsid, len, len, data);
}
